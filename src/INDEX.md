...
### Boot repair
1. [Recover Ubuntu Bootloader](kbook.html?file=bootrepair%2Frecover_ubuntu_bootloader.md)
2. [Recover Windows Bootloader](kbook.html?file=bootrepair%2Frecover_windows_bootloader.md)

### Code coverage
1. [Code coverage with Gcov](kbook.html?file=coverage%2Fgcov.md)
2. [Code coverage with Gcovr](kbook.html?file=coverage%2Fgcovr.md)

### Docker
1. [Build Multi-Architecture images](kbook.html?file=docker%2Fmulti-arch-image.md)

### Setup Chroot
* [Source packages to Chroot](kbook.html?file=chroot%2Finstall_source_to_chroot.md)
...
3. [GNU Global](kbook.html?file=codebrowser%2Fsetup_gnu_gtags.md)
4. [OpenGrok](kbook.html?file=codebrowser%2Fsetup_opengrok.md)

### Web based Git clients
1. [CGit](kbook.html?file=gitweb%2Fsetup_cgit.md)
2. [Gitweb](kbook.html?file=gitweb%2Fsetup_gitweb.md)
